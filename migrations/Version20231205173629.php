 ...
 */
final class Version20231205173629 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__incident AS SELECT id, bucket_test_id, created_at, status, message FROM incident');
        ...
        $this->addSql('INSERT INTO incident (id, bucket_id, created_at, status, message) SELECT id, bucket_test_id, created_at, status, message FROM __temp__incident');
    ...
    public function down(Schema $schema): void
    {
        ...
        , status VARCHAR(255) NOT NULL, message VARCHAR(255) NOT NULL, CONSTRAINT FK_3D03A11AA25C35F0 FOREIGN KEY (bucket_test_id) REFERENCES bucket_test (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO incident (id, bucket_test_id, created_at, status, message) SELECT id, bucket_id, created_at, status, message FROM __temp__incident');
        $this->addSql('DROP TABLE __temp__incident');
